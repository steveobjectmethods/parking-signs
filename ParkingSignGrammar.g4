...
everyDay : DAILY | NIGHTLY ;
dayToDay : day to day ;
dayAndDay : day and day ;
...
to : TO | DASH | THRU ;
and : AND | AMPERSAND ;
towAway : TOW DASH? AWAY ;
minute : MIN | MINUTE ;
exempt : EXEMPT | EXEMPTED ;
anyTime : ANYTIME | (ANY TIME) ;

NO : 'NO' ; // two meanings : negative (no) and abbreviation for number (No.)
PARKING : 'PARKING' ;
TO : 'TO' ;
THRU : 'THRU' ;
DASH : '-' ;
